...
const Card = ({ children, style = {}, onClick }) => (
  <div onClick={onClick} style={{ background: C.card, borderRadius: 16, border: `1px solid ${C.border}`, padding: 20, boxShadow: "0 2px 12px rgba(108,33,168,0.06)", cursor: onClick ? "pointer" : "default", ...style }}>{children}</div>
);
